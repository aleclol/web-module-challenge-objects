...
*/
console.log(createMenuItem('Pad Thai', 10, 'Dinner'));
//console.log(newItem);
console.log(createMenuItem('Crab Rangoon', 8, 'Dinner'));
console.log(createMenuItem('Fried Rice', 5, 'Dinner'));
...
const burger = {
  ...
  price: 18, 
  category: "Lunch",
  discount: function discountFunction (occupation){
...
function getLongReviews(array) {
    ...
    const longReview = 15;
    for(let i = 0; i < array.length; i++){
      if(array[i].feedback.length > longReview){
        newArr.push(array[i]);
      }
    }
return  newArr;
...
console.log(carMaker(50000,4321));
